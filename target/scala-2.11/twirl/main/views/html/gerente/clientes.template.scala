...
import play.mvc.Http.Context.Implicit._
     ...
     object clientes_Scope1 {
import helper._

class clientes extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
...
"""),_display_(/*11.2*/gerente/*11.9*/.base("Manager SIIAF","Clientes","Gestion de clientes","clientes",css,js)/*11.82*/{_display_(Seq[Any](format.raw/*11.83*/("""
	"""),format.raw/*12.2*/("""gestion de clientes
""")))}))
      }
    }
  }
